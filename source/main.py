...
from config import ENABLE_CUDA, DEBUG_MODE, DATA_PATH, VALIDATION_PATH, validation_loss_filename, train_loss_filename
...
def main():
    ...
    open(train_loss_filename, "w").close()
    open(validation_loss_filename, "w").close()
